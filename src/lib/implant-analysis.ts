...
const COMBAT_EXP_SKILLS = [ImplantEffect.StrengthExp, ImplantEffect.DefenseExp, ImplantEffect.DexterityExp, ImplantEffect.AgilityExp]
const ALL_SKILLS = [ImplantEffect.Strength, ImplantEffect.Defense, ImplantEffect.Dexterity, ImplantEffect.Agility, ImplantEffect.Hacking, ImplantEffect.Charisma]
const ALL_EXP_SKILLS = [ImplantEffect.StrengthExp, ImplantEffect.DefenseExp, ImplantEffect.DexterityExp, ImplantEffect.AgilityExp, ImplantEffect.HackingExp, ImplantEffect.CharismaExp]
...
export function getImplantsFromFactions(ns: NS): { [faction: string]: Implant[] } {
    ...
    for (const faction of FACTIONS) {
        const implants: Implant[] = ns.singularity.getAugmentationsFromFaction(faction)
            ...
            .map(implant => {
                ...
                const stats = [...convertMultipliers(ns.singularity.getAugmentationStats(implant))]
...
function convertMultipliers(multipliers: Multipliers): Set<ImplantEffect> {
    const effects: ImplantEffect[] = Object.entries(multipliers)
        ...
        .map(raw => {
            switch (raw) {
                case "strength": return ImplantEffect.Strength
                case "defense": return ImplantEffect.Defense
                case "dexterity": return ImplantEffect.Dexterity
                case "agility": return ImplantEffect.Agility
                case "charisma": return ImplantEffect.Charisma
                case "strength_exp": return ImplantEffect.StrengthExp
                case "defense_exp": return ImplantEffect.DefenseExp
                case "dexterity_exp": return ImplantEffect.DexterityExp
                case "agility_exp": return ImplantEffect.AgilityExp
                case "charisma_exp": return ImplantEffect.CharismaExp

                case "hacking": return ImplantEffect.Hacking
                case "hacking_exp": return ImplantEffect.HackingExp
                case "hacking_chance": return ImplantEffect.HackingChance
                case "hacking_money": return ImplantEffect.HackingMoney
                case "hacking_speed": return ImplantEffect.Speed
                case "hacking_grow": return ImplantEffect.Grow

                case "faction_rep": return ImplantEffect.FactionRep
                case "company_rep": return ImplantEffect.CompanyRep
                case "crime_money": return ImplantEffect.CrimeMoney
                case "crime_success": return ImplantEffect.CrimeChance
                case "work_money": return ImplantEffect.WorkMoney
                case "hacknet_node_money": return ImplantEffect.HacknetMoney
                default:
